  ...
  const handleProgress = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE}/mind-mystery/Progress?child_id=${childId}`,
        {
          method: "GET",
          headers: {
    ...
    >
      ...
      <View style={styles.mainContainer}>
        <View style={styles.contentWrapper}>
          <Image
            source={require("@/assets/images/games/mindMystery/progress1.png")}
        ...
        <View style={styles.bottomContainer}>
          <Image
            source={require("@/assets/images/games/mindMystery/img5.png")}
